 ...
 * @author dallasarivle
 */
public class v_homeBasdaLoginAslab extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homeBasdaLoginAslab() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homeBasdaLoginAslab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homeBasdaLoginAslab().setVisible(true);
            }
        });
    }

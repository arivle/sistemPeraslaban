 ...
 * @author dallasarivle
 */
public class v_homeBasdaLoginKalab extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homeBasdaLoginKalab() {
        initComponents();
    }

    public void ListAslab(ActionListener action) {
        menuListAslab.addActionListener(action);
    }
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homeBasdaLoginKalab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homeBasdaLoginKalab().setVisible(true);
            }
        });
    }

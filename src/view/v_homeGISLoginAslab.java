 ...
 * @author dallasarivle
 */
public class v_homeGISLoginAslab extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homeGISLoginAslab() {
        initComponents();
    }

   
    public JMenuItem inputNilai() {
        return menuInputNilai;
    }
    ...
    private void initComponents() {
        ...
        menuInputNilai.setText("Input nilai");
        jMenu2.add(menuInputNilai);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homeGISLoginAslab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homeGISLoginAslab().setVisible(true);
            }
        });
    }

 ...
 * @author dallasarivle
 */
public class v_homeGISLoginCalon extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homeGISLoginCalon() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>Merupakan Laboratorium yang berada di PSSI yang berfokus pada skill bidang Sistem Informasi Geografi</html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homeGISLoginCalon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homeGISLoginCalon().setVisible(true);
            }
        });
    }

 ...
 * @author dallasarivle
 */
public class v_homePemroLoginCalon extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homePemroLoginCalon() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homePemroLoginCalon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homePemroLoginCalon().setVisible(true);
            }
        });
    }

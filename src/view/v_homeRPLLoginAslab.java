 ...
 * @author dallasarivle
 */
public class v_homeRPLLoginAslab extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homeRPLLoginAslab() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homeRPLLoginAslab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homeRPLLoginAslab().setVisible(true);
            }
        });
    }

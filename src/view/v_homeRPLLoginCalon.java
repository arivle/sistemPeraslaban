 ...
 * @author dallasarivle
 */
public class v_homeRPLLoginCalon extends javax.swing.JFrame {

    /**
     * Creates new form v_homePemro
     */
    public v_homeRPLLoginCalon() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>Merupakan Laboratorium yang berada di PSSI yang berfokus pada skill desain sistem</html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_homeRPLLoginCalon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_homeRPLLoginCalon().setVisible(true);
            }
        });
    }
